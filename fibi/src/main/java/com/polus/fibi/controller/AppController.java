package com.polus.fibi.controller;
...
import com.polus.fibi.service.PersonService;


@CrossOrigin
@RestController
@RequestMapping("/")
@ComponentScan("com.polus.fibi")
public class AppController {
	 ...
	 * String listEmployees(ModelMap model) {
	 * 
	 ...
	 * model.addAttribute("employee", employee); model.addAttribute("edit", false);
	 * return "registration"; }
	 * 
	 * 
